...
import './svg/baocloud.svg';
import './svg/pencil-square.svg';
import './svg/log.svg';
import './svg/location.svg';
import './svg/location-dot.svg';
import './svg/locate.svg';
import './svg/roll-up.svg';
import './svg/drill-down.svg';
import './svg/global-drill-down.svg';
import './svg/angle-right.svg';
import './svg/topology.svg';
