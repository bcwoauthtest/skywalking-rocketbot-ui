...
export const SET_CURRENT_TOPO_SERVICE = 'SET_CURRENT_TOPO_SERVICE';
export const SET_TENANT_BS = 'SET_TENANT_BS';
export const SET_SELECTED_BS = 'SET_SELECTED_BS';
export const SET_CURRENT_TENANT = 'SET_CURRENT_TENANT';
export const SET_TRACE_QUERY_STATE = 'SET_TRACE_QUERY_STATE';
export const SET_SELECTED_CI_ID = 'SET_SELECTED_CI_ID';
export const SET_SELECTED_CI_CODE = 'SET_SELECTED_CI_CODE';
export const SET_SELECTED_TS = 'SET_SELECTED_TS';
export const SET_CURRENT_TENANT_NAME = 'SET_CURRENT_TENANT_NAME';
...
export const SET_TRACE_CURRENT_SERVICE = 'SET_TRACE_CURRENT_SERVICE';
...
export const SET_TOPO_DETAIL_SHOW = 'SET_TOPO_DETAIL_SHOW';
export const SET_TOPO_EDIT_SHOW = 'SET_TOPO_EDIT_SHOW';
export const SET_NODE_DEF_NAME = 'SET_NODE_DEF_NAME';
export const SET_NODE_DEF_TYPE = 'SET_NODE_DEF_TYPE';
export const SET_SELECTED_CI_SERVICES = 'SET_SELECTED_CI_SERVICES';
export const SET_SELECTED_CI_SERVICE_KEY_ARRAY = 'SET_SELECTED_CI_SERVICE_KEY_ARRAY';
export const SET_CAN_ROLL_UP = 'SET_CAN_ROLL_UP';
export const SET_CAN_DRILL_DOWN = 'SET_CAN_DRILL_DOWN';
export const SET_CURRENT_TOPO_LEVEL = 'SET_CURRENT_TOPO_LEVEL';
export const SET_TOPO_CURRENT_BS = 'SET_TOPO_CURRENT_BS';
export const SET_TOPO_CURRENT_TS = 'SET_TOPO_CURRENT_TS';
export const SET_TOPO_CURRENT_SERVICE = 'SET_TOPO_CURRENT_SERVICE';
export const SET_TOPO_SEARCH_SHOW = 'SET_TOPO_SEARCH_SHOW';
export const SET_TOPO_CURRENT_NODE = 'SET_TOPO_CURRENT_NODE';

// log
export const SET_LOG = 'SET_LOG';
export const SET_KI_COLUMNS = 'SET_KI_COLUMNS';
export const SET_LOG_TOTAL = 'SET_LOG_TOTAL';
export const CLEAR_LOG = 'CLEAR_LOG';
export const SET_CURRENT_CI = 'SET_CURRENT_CI';
export const SET_CURRENT_KI = 'SET_CURRENT_KI';
export const SET_KI_INFOS = 'SET_KI_INFOS';
export const SET_LOG_QUERY_FLAG = 'SET_LOG_QUERY_FLAG';
